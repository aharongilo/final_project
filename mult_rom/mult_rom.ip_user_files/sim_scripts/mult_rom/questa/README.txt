...
#
# Generated by export_simulation on Wed May 04 18:43:55 +0300 2022
#
################################################################################
...
switch to the './mult_rom.sh' script.

./mult_rom.sh -reset_run
...
./mult_rom.sh -noclean_files

For more information on the script, please type './mult_rom.sh -help'.
